...
Using eight real-world ransomwares plus two in-house ransomwares 
...
which is negligible considering NAND chip latency (50-500 $\mu$s). 
...
{\color{red}three disturbing application types}: applications with high rate of
...
usage pattern.  {\color{red}The background applications were divided into four
...
were used for training decision trees with ID3, and also for
...
{\color{red}For evaluation, experiment with each combination was conducted 20
...
report that the worst background noise came from CPU- and
IO-intensive jobs.  That is, they interfered with ransomware to
